...
'''python knn.py --dataset pyimagesearch/datasets'''
...
ap.add_argument("-k", "--neighbors", type=int, default=1, help="колличество ближайших соседей для классификации")
ap.add_argument("-j", "--jobs", type=int, default=-1, help="колличество ядер для вычисления расстояния k-NN (-1 - все ядра)")
