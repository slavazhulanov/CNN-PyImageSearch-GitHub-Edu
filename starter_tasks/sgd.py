...
ap.add_argument("-e", "--epochs", type=float, default=100, help="колличество эпох")
ap.add_argument("-a", "--alpha", type=float, default=0.01, help="скорость обучения")
ap.add_argument("-b", "--batch-size", type=float, default=32, help="размер мини батча")
