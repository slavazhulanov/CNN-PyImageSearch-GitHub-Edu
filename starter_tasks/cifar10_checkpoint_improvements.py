...
ap.add_argument("-w", "--weights", required=True, help="path tp weights directory")
...
checkpoint = ModelCheckpoint(fname, monitor="val_loss", model="min", save_best_only=True, verbose=1)
